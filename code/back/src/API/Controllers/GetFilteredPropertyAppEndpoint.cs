...
[Tags("APP Properties")]
[ApiController]
public class GetFilteredPropertyAppEndpoint : ControllerBase
{
    private readonly IMediator _mediator;

    public GetFilteredPropertyAppEndpoint(IMediator mediator)
    {
        _mediator = mediator;
    }
    /// <summary>
    ...
    [Route("api/v{version:apiVersion}/app/getpropertybyfilters")]
    [HttpPost]
    ...
    [ProducesResponseType(StatusCodes.Status409Conflict)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    [Route("api/v{version:apiVersion}/app/getpropertytop/{top}")]
    [HttpGet]
